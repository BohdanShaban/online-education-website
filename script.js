...
/* harmony import */ var _modules_slidersHierarhy_slider_main__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/slidersHierarhy/slider-main */ "./src/js/modules/slidersHierarhy/slider-main.js");
/* harmony import */ var _modules_playYouTubeVid__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/playYouTubeVid */ "./src/js/modules/playYouTubeVid.js");
/* harmony import */ var _modules_slidersHierarhy_slider_mini__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/slidersHierarhy/slider-mini */ "./src/js/modules/slidersHierarhy/slider-mini.js");
/* harmony import */ var _modules_educationDifferences__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/educationDifferences */ "./src/js/modules/educationDifferences.js");
/* harmony import */ var _modules_formsPostOnServ__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/formsPostOnServ */ "./src/js/modules/formsPostOnServ.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var mainSlider = new _modules_slidersHierarhy_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    containerSel: '.page',
    btnsSel: '.next'
  });
  mainSlider.render();
  var playYouTubeVid = new _modules_playYouTubeVid__WEBPACK_IMPORTED_MODULE_1__["default"]('.showup .play', '.overlay', '.overlay .close');
  playYouTubeVid.setPlayer(); // MINI SLIDERS

  var showUpMiniSlider = new _modules_slidersHierarhy_slider_mini__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  var modulesMiniSlider = new _modules_slidersHierarhy_slider_mini__WEBPACK_IMPORTED_MODULE_2__["default"]({
    ...
    activeClass: 'card-active',
    animate: true,
    // Change Slide Header/Arrow opasity = '1'
    autoPlay: true
  });
  modulesMiniSlider.init();
  var clientsFeedMiniSlider = new _modules_slidersHierarhy_slider_mini__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  clientsFeedMiniSlider.init(); // DIFFERENCES BLOCK  ( Only in 1 Exemple )

  new _modules_educationDifferences__WEBPACK_IMPORTED_MODULE_3__["default"]({
...
/***/ "./src/js/modules/educationDifferences.js":
/*!************************************************!*\
  !*** ./src/js/modules/educationDifferences.js ***!
  \************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return educationDifferences; });
...
var educationDifferences =
/*#__PURE__*/
function () {
  function educationDifferences() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        _ref$oldContainerSel = _ref.oldContainerSel,
        oldContainerSel = _ref$oldContainerSel === void 0 ? null : _ref$oldContainerSel,
        _ref$newContainerSel = _ref.newContainerSel,
        newContainerSel = _ref$newContainerSel === void 0 ? null : _ref$newContainerSel,
        _ref$cardItemSel = _ref.cardItemSel,
        cardItemSel = _ref$cardItemSel === void 0 ? null : _ref$cardItemSel,
        _ref$clickDivSel = _ref.clickDivSel,
        clickDivSel = _ref$clickDivSel === void 0 ? null : _ref$clickDivSel;

    _classCallCheck(this, educationDifferences);
  ...
  _createClass(educationDifferences, [{
    key: "hideCardsAndShowCard",
    value: function hideCardsAndShowCard() {
      // HIDE ALL CARDS  !!! BUT !!!  NOT LAST
      this.oldCards.forEach(function (oldCard, idx, arrPointer) {
      ...
      this.newCards.forEach(function (newCard, idx, arrPointer) {
        //  !!! arrPointer
        if (idx !== arrPointer.length - 1) {
    ...
    key: "showCardsOneByOne",
    value: function showCardsOneByOne(cardsArr, trigBtn) {
      // !!! NEED break
      for (var i = 0; i < cardsArr.length; i++) {
        var card = cardsArr[i]; // CURRENT CARD IS HIDED
    ...
    value: function bindTriggers() {
      ...
      this.oldClickBtn.addEventListener('click', function () {
        _this.showCardsOneByOne(_this.oldCards, _this.oldClickBtn);
      });
      this.newClickBtn.addEventListener('click', function () {
        _this.showCardsOneByOne(_this.newCards, _this.newClickBtn);
      });
    }
  }, {
    key: "init",
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return formsPostOnServ; });
...
/*#__PURE__*/
function () {
  function formsPostOnServ() {
    _classCallCheck(this, formsPostOnServ);
  ...
  _createClass(formsPostOnServ, [{
    key: "clearAllInputs",
    value: function clearAllInputs() {
      this.inputsArr.forEach(function (input) {
    ...
    key: "checkNOTCyrillicInputs",
    value: function checkNOTCyrillicInputs(selector) {
      var mailInputs = document.querySelectorAll(selector);
    ...
    key: "allFormsInit",
    value: function allFormsInit() {
      var _this = this;

      // ONLY NOT CYRYLIC INPUT OR NUMBS
      this.checkNOTCyrillicInputs('[type="email"]'); //PHONE MASK

      this.initMask('[name="phone"]');
      this.formsArr.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          // !!! 'submit'  —>  e.preventDefault();
          e.preventDefault(); // MESSAGE EL <div> CREATION
          ...
          }, 400); // MAKE FormData OBJ

          var formData = new FormData(form); // POST Data (FormData Obj) On Server
...
/***/ "./src/js/modules/playYouTubeVid.js":
/*!******************************************!*\
  !*** ./src/js/modules/playYouTubeVid.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PlayYouTubeVid; });
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
...
/*#__PURE__*/
function () {
  function PlayYouTubeVid(trigsBtnsSel, modalWindSel, closeBtnSel) {
    _classCallCheck(this, PlayYouTubeVid);
  ...
  _createClass(PlayYouTubeVid, [{
    key: "youTubePlayerInit",
    value: function youTubePlayerInit() {
    ...
    value: function createYouTubePlayer(url) {
      this.youTubePlayerInit(); // 3. This function creates an <iframe> (and YouTube player)

      this.player = new YT.Player('frame', {
        // !!! 'frame' -> Uniq Id -> <div id='frame'></div>
        height: '100%',
        width: '100%',
        videoId: "".concat(url)
      });
    ...
    key: "bindTrigBtns",
    value: function bindTrigBtns() {
      var _this = this;

      this.trigsBtns.forEach(function (btn) {
    ...
    value: function bindCloseBtn() {
      ...
      this.closeBtn.addEventListener('click', function () {
        _this2.modalWind.style.display = 'none';
...
/***/ "./src/js/modules/slidersHierarhy/slider-main.js":
/*!*******************************************************!*\
  !*** ./src/js/modules/slidersHierarhy/slider-main.js ***!
  \*******************************************************/
/*! exports provided: default */
...
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./slider */ "./src/js/modules/slidersHierarhy/slider.js");
...
function (_Slider) {
  ...
  function SliderMain(containerSel, btnsSel) {
    var _this;
  ...
  _createClass(SliderMain, [{
    ...
    value: function showSlides(n) {
      ...
      if (this.slideIndex == 3) {
        var showBlock = this.slides[this.slideIndex - 1].querySelector('.hanson');
...
/***/ "./src/js/modules/slidersHierarhy/slider-mini.js":
/*!*******************************************************!*\
  !*** ./src/js/modules/slidersHierarhy/slider-mini.js ***!
  \*******************************************************/
/*! exports provided: default */
...
function (_Slider) {
  ...
  function SliderMini(containerSel, nextBtnSel, prevBtnSel, activeClass, animate, autoPlay) {
    var _this;

    _classCallCheck(this, SliderMini);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(SliderMini).call(this, containerSel, nextBtnSel, prevBtnSel, activeClass, animate, autoPlay));
    _this.intervalId;
    return _this;
  }
  ...
  _createClass(SliderMini, [{
    ...
    value: function decorizeSlides() {
      ...
      this.slides.forEach(function (slide) {
        slide.classList.remove(_this2.activeClass); //Make INVISIBLE ALL Titles & Arrows
    ...
    key: "bindTrigsBtns",
    value: function bindTrigsBtns() {
      var _this3 = this;

      this.nextBtn.addEventListener('click', function () {
        // STOP TIMER 
        clearInterval(_this3.intervalId); // Next Slide f()

        _this3.nextSlide();
      });
      this.prevBtn.addEventListener('click', function () {
        var lastSlide = _this3.slides[_this3.slides.length - 1]; // !!! slides.length-1
        // IF( Last El == Butt —> Last & Sec Last Elms  Becomes Firs

        if (lastSlide.nodeName === 'BUTTON') {
          _this3.container.insertBefore(lastSlide, _this3.slides[0]);

          lastSlide = _this3.slides[_this3.slides.length - 1];
    ...
    key: "autoPlaySlider",
    value: function autoPlaySlider(mSecs) {
      var _this4 = this;
...
/***/ "./src/js/modules/slidersHierarhy/slider.js":
/*!**************************************************!*\
  !*** ./src/js/modules/slidersHierarhy/slider.js ***!
  \**************************************************/
/*! exports provided: default */
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      _ref$containerSel = _ref.containerSel,
      containerSel = _ref$containerSel === void 0 ? null : _ref$containerSel,
      _ref$slidesSel = _ref.slidesSel,
      slidesSel = _ref$slidesSel === void 0 ? null : _ref$slidesSel,
      _ref$btnsSel = _ref.btnsSel,
      btnsSel = _ref$btnsSel === void 0 ? null : _ref$btnsSel,
      _ref$nextBtnSel = _ref.nextBtnSel,
      nextBtnSel = _ref$nextBtnSel === void 0 ? null : _ref$nextBtnSel,
      _ref$prevBtnSel = _ref.prevBtnSel,
      prevBtnSel = _ref$prevBtnSel === void 0 ? null : _ref$prevBtnSel,
